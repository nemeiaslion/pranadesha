...
/**
 * User TimeZone entity responsible for provide available time zones for user
 * 
 * @author vinic
 * @version 1.0, 2018-02-13
 *
 */
public class UserTimeZone implements Serializable, Comparable<UserTimeZone> {
	 ...
	 * @param locale
	 */
	public UserTimeZone(String id, Locale locale) {
	 ...
	 * @param locale
	 */
	public UserTimeZone(TimeZone timeZone, Locale locale) {
		id = timeZone.getID();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof UserTimeZone)) {
			return false;
		}
	 ...
	 */
	@Override
	public int compareTo(UserTimeZone o) {
